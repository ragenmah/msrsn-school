...
public class Notes_PDFActivity extends AppCompatActivity implements OnLoadCompleteListener, OnPageErrorListener {
    Button button;
    Long queueId;
...
//                 request.setDescription("Android Data download using DownloadManager.");
                ...
                request.setDestinationInExternalFilesDir(Notes_PDFActivity.this, Environment.DIRECTORY_DOWNLOADS,filename+" QUESTIONS.pdf");
                request.setNotificationVisibility(DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED);
                queueId=downloadManager.enqueue(request);
                Toast toast = Toast.makeText(Notes_PDFActivity.this,
        ...
        FileLoader.with(this)
                ...
                .asFile(new FileRequestListener<File>() {
                    ...
                    public void onLoad(FileLoadRequest request, FileResponse<File> response) {
                        ...
                        try {
                            pdfView.fromFile(pdfFile)
                                    ...
                                    .onLoad(Notes_PDFActivity.this)
                                    .scrollHandle(new DefaultScrollHandle(Notes_PDFActivity.this))
                                    .spacing(10) // in dp
                                    .onPageError(Notes_PDFActivity.this)
                                    .load();
                    ...
                    public void onError(FileLoadRequest request, Throwable t) {
                        pdfViewProgressBar.setVisibility(View.GONE);
                        Toast.makeText(Notes_PDFActivity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });
    }
    @Override
