...
public class semester4oldquestion  extends AppCompatActivity {
...
//    }
    ...
    public class JSONDownloader {
        ...
        private static   final String PDF_SITE_URL="http://msrsn.com/android/data_passing_to_android.php?s1=4";
...
//        Button btnRetrieve= findViewById(R.id.downloadBtn);
        ...
        new JSONDownloader(semester4oldquestion.this).retrieve(myGridView,myProgressBar);
