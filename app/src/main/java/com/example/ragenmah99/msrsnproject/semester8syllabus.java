...
public class semester8syllabus  extends AppCompatActivity {
    public class PDFDoc {
        int id;
...
//    }
    ...
    public class JSONDownloader {
        private static final String PDF_SITE_URL="http://msrsn.com/android/syllabus_download.php?"+"s1=8";
...
//        Button btnRetrieve= findViewById(R.id.downloadBtn);
        ...
        new JSONDownloader(semester8syllabus.this).retrieve(myGridView,myProgressBar);
