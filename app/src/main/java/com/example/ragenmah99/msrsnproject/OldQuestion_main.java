...
public class OldQuestion_main  extends AppCompatActivity {
    public class PDFDoc {
        int id;
...
//    }
    ...
    public class JSONDownloader {
        private static final String PDF_SITE_URL="http://msrsn.com/android/data_passing_to_android.php";
...
//        Button btnRetrieve= findViewById(R.id.downloadBtn);
        ...
        new JSONDownloader(OldQuestion_main.this).retrieve(myGridView,myProgressBar);
