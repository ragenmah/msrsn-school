...
public class semester1oldquestion  extends AppCompatActivity {
...
//    }
    ...
    public class JSONDownloader {
        ...
        private static   final String PDF_SITE_URL="http://msrsn.com/android/data_passing_to_android.php?"+"s1=1";
...
//        Button btnRetrieve= findViewById(R.id.downloadBtn);
        ...
        new JSONDownloader(semester1oldquestion.this).retrieve(myGridView,myProgressBar);
