...
public class semester7syllabus  extends AppCompatActivity {
    public class PDFDoc {
        int id;
...
//    }
    ...
    public class JSONDownloader {
        private static final String PDF_SITE_URL="http://msrsn.com/android/syllabus_download.php?"+"s1=7";
...
//                            Toast.makeText(c, "UNSUCCESSFUL :  ERROR IS : "+error.getMessage(), Toast.LENGTH_LONG).show();
                            Toast.makeText(c, "Please connect WiFi ", Toast.LENGTH_LONG).show();
...
//        Button btnRetrieve= findViewById(R.id.downloadBtn);
        ...
        new JSONDownloader(semester7syllabus.this).retrieve(myGridView,myProgressBar);
...
//            @Override
//            public void onClick(View view) {
////                new JSONDownloader(Syllabus_main.this).retrieve(myGridView,myProgressBar);
//            }
//        });
    }
    @Override
