...
//    }
    ...
    public class JSONDownloader {
        private static final String PDF_SITE_URL="http://msrsn.com/android/syllabus_download.php?"+"s1=4";
...
//        Button btnRetrieve= findViewById(R.id.downloadBtn);
        ...
        new JSONDownloader(semester4syllabus.this).retrieve(myGridView,myProgressBar);
