...
public class semester4notes  extends AppCompatActivity {
...
//    }
    ...
    public class JSONDownloader {
        ...
        private static   final String PDF_SITE_URL="http://msrsn.com/android/notes_download.php?"+"s1=4";
...
//        Button btnRetrieve= findViewById(R.id.downloadBtn);
        ...
        new JSONDownloader(semester4notes.this).retrieve(myGridView,myProgressBar);
