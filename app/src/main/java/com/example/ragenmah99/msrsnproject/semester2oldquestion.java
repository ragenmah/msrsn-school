...
public class semester2oldquestion  extends AppCompatActivity {
...
//    }
    ...
    public class JSONDownloader {
        ...
        private static   final String PDF_SITE_URL="http://msrsn.com/android/data_passing_to_android.php?"+"s1=2";
...
//        Button btnRetrieve= findViewById(R.id.downloadBtn);
        ...
        new JSONDownloader(semester2oldquestion.this).retrieve(myGridView,myProgressBar);
