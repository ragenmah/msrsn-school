...
public class Misc_main  extends AppCompatActivity {
    public class PDFDoc {
        int id;
...
//    }
    ...
    public class JSONDownloader {
        private static final String PDF_SITE_URL="http://msrsn.com/android/misc_download.php";
...
//                                    String name=jo.getString("sem_name");
                                    String name=jo.getString("topic");;
//                                    String category=jo.getString("category");
//                                    String description=jo.getString("description");
                                    String pdfURL=jo.getString("report");
...
//        Button btnRetrieve= findViewById(R.id.downloadBtn);
        ...
        new JSONDownloader(Misc_main.this).retrieve(myGridView,myProgressBar);
