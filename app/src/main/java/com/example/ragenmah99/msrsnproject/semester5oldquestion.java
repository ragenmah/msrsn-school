...
public class semester5oldquestion  extends AppCompatActivity {
...
//    }
    ...
    public class JSONDownloader {
        ...
        private static   final String PDF_SITE_URL="http://msrsn.com/android/data_passing_to_android.php?"+"s1=5";
...
//        Button btnRetrieve= findViewById(R.id.downloadBtn);
        ...
        new JSONDownloader(semester5oldquestion.this).retrieve(myGridView,myProgressBar);
