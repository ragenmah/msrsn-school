...
public class Misc_PDFActivity extends AppCompatActivity implements OnLoadCompleteListener, OnPageErrorListener {
    Button button;
    Long queueId;
...
//                 request.setDescription("Android Data download using DownloadManager.");
                ...
                request.setDestinationInExternalFilesDir(Misc_PDFActivity.this, Environment.DIRECTORY_DOWNLOADS,filename+" QUESTIONS.pdf");
                request.setNotificationVisibility(DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED);
                queueId=downloadManager.enqueue(request);
                Toast toast = Toast.makeText(Misc_PDFActivity.this,
        ...
        FileLoader.with(this)
                ...
                .asFile(new FileRequestListener<File>() {
                    ...
                    public void onLoad(FileLoadRequest request, FileResponse<File> response) {
                        ...
                        try {
                            pdfView.fromFile(pdfFile)
                                    ...
                                    .onLoad(Misc_PDFActivity.this)
                                    .scrollHandle(new DefaultScrollHandle(Misc_PDFActivity.this))
                                    .spacing(10) // in dp
                                    .onPageError(Misc_PDFActivity.this)
                                    .load();
                    ...
                    public void onError(FileLoadRequest request, Throwable t) {
                        pdfViewProgressBar.setVisibility(View.GONE);
                        Toast.makeText(Misc_PDFActivity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });
    }
    @Override
