...
//    }
    ...
    public class JSONDownloader {
        private static final String PDF_SITE_URL="http://msrsn.com/android/syllabus_download.php?"+"s1=5";
...
//        Button btnRetrieve= findViewById(R.id.downloadBtn);
        ...
        new JSONDownloader(semester5syllabus.this).retrieve(myGridView,myProgressBar);
